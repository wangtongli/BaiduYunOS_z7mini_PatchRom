...
.method private initStringIds()V
    ...
    :array_0
    .array-data 0x4
        #android:string@progress_unmounting#a
        #android:string@internal_storage_progress_unmounting#a
        #android:string@usb_otg_progress_unmounting#a
    .end array-data

    :array_1
    .array-data 0x4
        #android:string@progress_erasing#a
        #android:string@internal_storage_progress_erasing#a
        #android:string@usb_otg_progress_erasing#a
    .end array-data

    :array_2
    .array-data 0x4
        #android:string@format_error#a
        #android:string@internal_storage_format_error#a
        #android:string@usb_otg_format_error#a
    .end array-data

    :array_3
    .array-data 0x4
        #android:string@media_bad_removal#a
        #android:string@internal_storage_media_bad_removal#a
        #android:string@usb_otg_media_bad_removal#a
    .end array-data

    :array_4
    .array-data 0x4
        #android:string@media_checking#a
        #android:string@internal_storage_media_checking#a
        #android:string@usb_otg_media_checking#a
    .end array-data

    :array_5
    .array-data 0x4
        #android:string@media_removed#a
        #android:string@internal_storage_media_removed#a
        #android:string@usb_otg_media_removed#a
    .end array-data

    :array_6
    .array-data 0x4
        #android:string@media_shared#a
        #android:string@internal_storage_media_shared#a
        #android:string@usb_otg_media_shared#a
    .end array-data
.end method
