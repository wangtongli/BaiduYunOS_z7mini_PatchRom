...
.method public static main([Ljava/lang/String;)V
    ...
    .line 575
    const-string v4, "persist.powermo.disfeature"
    ...
    sput-object v4, Landroid/util/PowerMoConfig;->FEATURE:Ljava/lang/String;

    .line 576
    sget-object v4, Landroid/util/PowerMoConfig;->FEATURE:Ljava/lang/String;
    ...
    sput-boolean v4, Landroid/util/PowerMoConfig;->WITHOUT_ALL:Z
    ...
    :goto_0
    sput-boolean v4, Landroid/util/PowerMoConfig;->WITHOUT_SMART_DISPLAY:Z
    ...
    :goto_1
    sput-boolean v4, Landroid/util/PowerMoConfig;->WITHOUT_SMART_AUDIO:Z
    ...
    :goto_2
    sput-boolean v4, Landroid/util/PowerMoConfig;->WITHOUT_SMART_SENSOR:Z
    ...
    :goto_3
    sput-boolean v4, Landroid/util/PowerMoConfig;->WITHOUT_SMART_INPUT:Z
    ...
    const-string v5, "smart-configuration"
    ...
    :goto_4
    sput-boolean v4, Landroid/util/PowerMoConfig;->WITHOUT_SMART_CONFIGURATION:Z
    ...
    sget-boolean v4, Landroid/util/PowerMoConfig;->WITHOUT_SMART_DISPLAY:Z

    if-nez v4, :cond_5

    sget-boolean v4, Landroid/util/PowerMoConfig;->WITHOUT_SMART_INPUT:Z

    if-nez v4, :cond_5

    sget-object v4, Landroid/util/PowerMoConfig;->FEATURE:Ljava/lang/String;

    const-string v5, "shopm"
    ...
    :goto_5
    sput-boolean v4, Landroid/util/PowerMoConfig;->WITHOUT_SHOPM:Z
    ...
    :goto_6
    sput-boolean v4, Landroid/util/PowerMoConfig;->WITHOUT_FLOATING:Z
    ...
    const-string v5, "remote-display"
    ...
    :cond_8
    sput-boolean v2, Landroid/util/PowerMoConfig;->WITHOUT_REMOTE_DISPLAY:Z
