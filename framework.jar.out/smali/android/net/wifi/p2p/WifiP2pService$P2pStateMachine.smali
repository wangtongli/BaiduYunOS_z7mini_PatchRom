...
.method private getPersistedDeviceName()Ljava/lang/String;
    ...
    .line 2613
    .local v0, defaultBranch:Ljava/lang/String;
    ...
    .line 2615
    .local v1, defaultProduct:Ljava/lang/String;
    const-string/jumbo v5, "persist.sys.wifi.p2pname"
    ...
    .line 2621
    .end local v0           #defaultBranch:Ljava/lang/String;
    .end local v1           #defaultProduct:Ljava/lang/String;
...
.method private initializeP2pSettings()V
    ...
    invoke-static {v1, v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$12802(Landroid/net/wifi/p2p/WifiP2pService;B)B
    ...
    invoke-static {v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$12900(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;
...
.method private notifyInvitationReceived()V
    ...
    const-string v7, "auto connect setup "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, v5, Landroid/net/wifi/WpsInfo;->setup:I

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v6

    const-string v7, " save config addr "
    ...
    const-string v7, " mBeamDeviceAddress "
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mBeamDeviceAddress:Ljava/lang/String;
    invoke-static {v7}, Landroid/net/wifi/p2p/WifiP2pService;->access$12400(Landroid/net/wifi/p2p/WifiP2pService;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v6}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->loge(Ljava/lang/String;)V
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mBeamDeviceAddress:Ljava/lang/String;
    invoke-static {v6}, Landroid/net/wifi/p2p/WifiP2pService;->access$12400(Landroid/net/wifi/p2p/WifiP2pService;)Ljava/lang/String;
    ...
    #setter for: Landroid/net/wifi/p2p/WifiP2pService;->mBeamDeviceAddress:Ljava/lang/String;
    invoke-static {v6, v8}, Landroid/net/wifi/p2p/WifiP2pService;->access$12402(Landroid/net/wifi/p2p/WifiP2pService;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v8, p0, v5}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$4;-><init>(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/WpsInfo;)V
    ...
    invoke-direct {v7, p0, v5}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$3;-><init>(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/WpsInfo;)V
...
.method private updatePersistentNetworks(Z)V
    ...
    invoke-virtual {v4, v13}, Landroid/net/wifi/p2p/WifiP2pGroup;->setNetworkName(Ljava/lang/String;)V
