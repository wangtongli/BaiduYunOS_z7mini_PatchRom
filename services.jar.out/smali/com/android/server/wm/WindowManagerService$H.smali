...
.field public static final REABLE_POWER_HOME_FUNCTION_TIMEOUT:I = 0x22
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    sput-boolean v2, Lcom/android/server/wm/WindowManagerService;->Flag_EndCall:Z

    .line 7806
    const/4 v2, 0x0

    sput-boolean v2, Lcom/android/server/wm/WindowManagerService;->Flag_Home:Z

    .line 7807
    const-string v2, "chengjiaqi"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "REABLE_POWER_HOME_FUNCTION_TIMEOUT flag_endcall-"

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    sget-boolean v4, Lcom/android/server/wm/WindowManagerService;->Flag_EndCall:Z

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v4, "-flag_home-"

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    sget-boolean v4, Lcom/android/server/wm/WindowManagerService;->Flag_Home:Z
