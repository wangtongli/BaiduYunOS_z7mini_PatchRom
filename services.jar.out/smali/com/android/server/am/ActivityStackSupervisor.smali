...
.method adjustStackFocus(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityStack;
    ...
    iget v8, p0, Lcom/android/server/am/ActivityStackSupervisor;->mDisplayId:I

    invoke-interface {v7, v8, p1}, Lcom/android/server/am/IAmSmartShowFuncs;->getStackLocked(ILcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityStack;

    move-result-object v0

    .line 1427
    .local v0, specifiedStack:Lcom/android/server/am/ActivityStack;
    if-eqz v0, :cond_4

    .line 1428
    sget-boolean v7, Landroid/util/PowerMoConfig;->WITHOUT_FLOATING:Z
    ...
    invoke-interface {v7, v0}, Lcom/android/server/am/IAmSmartShowFuncs;->isFloatingStack(Lcom/android/server/am/ActivityStack;)Z
    ...
    .line 1481
    .end local v0           #specifiedStack:Lcom/android/server/am/ActivityStack;
    :cond_2
    :goto_1
    return-object v0

    .restart local v0       #specifiedStack:Lcom/android/server/am/ActivityStack;
    :cond_3
    move-object v6, v0
    ...
    invoke-interface {v7, v5}, Lcom/android/server/am/IAmSmartShowFuncs;->isFloatingStack(Lcom/android/server/am/ActivityStack;)Z
    ...
    :cond_8
    iget-object v6, p0, Lcom/android/server/am/ActivityStackSupervisor;->mFocusedFloatingStack:Lcom/android/server/am/ActivityStack;
    ...
    invoke-interface {v6, v1}, Lcom/android/server/am/IAmSmartShowFuncs;->isFloatingStack(Lcom/android/server/am/ActivityStack;)Z
    ...
    invoke-virtual {v6, v7, v8, v9, v10}, Lcom/android/server/am/ActivityManagerService;->createStack(IIIF)I
...
.method moveTaskToStack(IIZ)V
    ...
    .line 2400
    :cond_3
    invoke-virtual {p0, v9}, Lcom/android/server/am/ActivityStackSupervisor;->removeTask(Lcom/android/server/am/TaskRecord;)V

    .line 2401
    invoke-virtual {v8, v9, p3}, Lcom/android/server/am/ActivityStack;->addTask(Lcom/android/server/am/TaskRecord;Z)V
    ...
    .line 2407
    .local v10, topAr:Lcom/android/server/am/ActivityRecord;
    if-eqz v10, :cond_4
    ...
    .line 2412
    .end local v10           #topAr:Lcom/android/server/am/ActivityRecord;
    :cond_4
    sget-boolean v0, Landroid/util/PowerMoConfig;->WITHOUT_ALL:Z
...
.method final startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;IZLandroid/os/Bundle;)I
    ...
    invoke-interface {v4, v15, v0}, Lcom/android/server/am/IAmSmartShowFuncs;->tryReuseTaskLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;)I
