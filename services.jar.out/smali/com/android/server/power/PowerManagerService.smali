...
.field private showLogHandlerThread:Landroid/os/HandlerThread;
...
.method static constructor <clinit>()V
    ...
    .line 80
    sput-boolean v0, Lcom/android/server/power/PowerManagerService;->isFactory:Z
...
.method public constructor <init>()V
    ...
    .line 387
    iput-object v2, p0, Lcom/android/server/power/PowerManagerService;->showLogHandlerThread:Landroid/os/HandlerThread;
...
.method static synthetic access$1200(Lcom/android/server/power/PowerManagerService;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1300(Lcom/android/server/power/PowerManagerService;J)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$3100(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/display/DisplayManagerService;
    .locals 1
    .parameter "x0"
...
.method private acquireWakeLockInternal(Landroid/os/IBinder;ILjava/lang/String;Ljava/lang/String;Landroid/os/WorkSource;II)V
    ...
    iget-object v2, v0, Lcom/android/server/power/PowerManagerService;->mBlockedUids:Ljava/util/ArrayList;
    ...
    .line 664
    :cond_0
    const-string v2, "persist.service.powersave.logs"
    ...
    sput-boolean v2, Lcom/android/server/power/PowerManagerService;->showLog:Z

    .line 666
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/power/PowerManagerService;->showLogHandlerThread:Landroid/os/HandlerThread;
    ...
    iput-object v2, v0, Lcom/android/server/power/PowerManagerService;->showLogHandlerThread:Landroid/os/HandlerThread;
    ...
    .line 669
    new-instance v2, Lcom/android/server/power/PowerManagerService$WakeLockHandler;

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/power/PowerManagerService;->showLogHandlerThread:Landroid/os/HandlerThread;
    ...
    invoke-direct {v2, v0, v3}, Lcom/android/server/power/PowerManagerService$WakeLockHandler;-><init>(Lcom/android/server/power/PowerManagerService;Landroid/os/Looper;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/power/PowerManagerService;->showLogHandler:Lcom/android/server/power/PowerManagerService$WakeLockHandler;

    .line 670
    const-string v2, "PowerManagerService"

    const-string v3, "showLogHandlerThread start!"
    ...
    invoke-direct/range {v1 .. v12}, Lcom/android/server/power/PowerManagerService;->showWakeLock(ZLjava/lang/String;ILjava/lang/String;Landroid/os/IBinder;ILjava/lang/String;Ljava/lang/String;Landroid/os/WorkSource;II)V
    ...
    const-string v3, "showLogHandlerThread quit!"
...
.method private checkScreenState(I)V
    ...
    const-string v1, "newScreenState is SCREEN_STATE_OFF!!!"
    ...
    const-string v1, "newScreenState isn\'t SCREEN_STATE_OFF, removeMessages MSG_CHECK_WAKELOCK_LIST!"
...
.method private checkWakeLockArrayList()V
    ...
    const-string v1, "The screen is on, cancel checking WakeLock ArrayList."
...
.method private releaseWakeLockInternal(Landroid/os/IBinder;I)V
    ...
    .line 779
    invoke-direct {p0, v13}, Lcom/android/server/power/PowerManagerService;->notifyWakeLockReleasedLocked(Lcom/android/server/power/PowerManagerService$WakeLock;)V
    ...
    .line 786
    :cond_2
    iget v0, v13, Lcom/android/server/power/PowerManagerService$WakeLock;->mFlags:I
    ...
    iput-boolean v1, v0, Lcom/android/server/power/DisplayPowerRequest;->useProximitySensorInAsleep:Z

    .line 790
    :cond_3
    invoke-direct {p0, v13}, Lcom/android/server/power/PowerManagerService;->applyWakeLockFlagsOnReleaseLocked(Lcom/android/server/power/PowerManagerService$WakeLock;)V
...
.method private updateDisplayPowerStateLocked(I)V
    ...
    .line 1829
    :cond_0
    sget-boolean v4, Lcom/android/server/power/PowerManagerService;->showLog:Z
...
.method public setKeyboardLightOff(Z)V
    .locals 0
    .parameter "keyboard"

    .prologue
    .line 449
    sput-boolean p1, Lcom/android/server/power/PowerManagerService;->isFactory:Z
