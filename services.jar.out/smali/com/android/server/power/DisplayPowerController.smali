...
.field private mZteAutoBrightnessAdjObserver:Landroid/database/ContentObserver;

.field private mZteBrightnessUtils:Lcom/android/server/power/ZteBrightnessUtils;
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/server/power/Notifier;Lcom/android/server/LightsService;Lcom/android/server/TwilightService;Landroid/hardware/SensorManager;Lcom/android/server/display/DisplayManagerService;Lcom/android/server/power/SuspendBlocker;Lcom/android/server/power/DisplayBlanker;Lcom/android/server/power/DisplayPowerController$Callbacks;Landroid/os/Handler;)V
    ...
    iput-boolean v5, p0, Lcom/android/server/power/DisplayPowerController;->mAutoBrightnessZteControlMode:Z
    ...
    invoke-direct {v5, p0, v6}, Lcom/android/server/power/DisplayPowerController$1;-><init>(Lcom/android/server/power/DisplayPowerController;Landroid/os/Handler;)V

    iput-object v5, p0, Lcom/android/server/power/DisplayPowerController;->mZteAutoBrightnessAdjObserver:Landroid/database/ContentObserver;
    ...
    iput v5, p0, Lcom/android/server/power/DisplayPowerController;->buttonLightFlag:I
    ...
    iput-object v5, p0, Lcom/android/server/power/DisplayPowerController;->buttonLightHandler:Landroid/os/Handler;
    ...
    .line 410
    new-instance v5, Lcom/android/server/power/ZteBrightnessUtils;

    invoke-direct {v5, p2}, Lcom/android/server/power/ZteBrightnessUtils;-><init>(Landroid/content/Context;)V

    iput-object v5, p0, Lcom/android/server/power/DisplayPowerController;->mZteBrightnessUtils:Lcom/android/server/power/ZteBrightnessUtils;

    .line 411
    iget-object v5, p0, Lcom/android/server/power/DisplayPowerController;->mZteBrightnessUtils:Lcom/android/server/power/ZteBrightnessUtils;

    iget-boolean v6, p0, Lcom/android/server/power/DisplayPowerController;->mAutoBrightnessZteControlMode:Z

    invoke-virtual {v5, v6}, Lcom/android/server/power/ZteBrightnessUtils;->setutoBrightnessZteControlModeEnable(Z)V

    .line 412
    iget-object v5, p0, Lcom/android/server/power/DisplayPowerController;->mZteBrightnessUtils:Lcom/android/server/power/ZteBrightnessUtils;

    iget-object v6, p0, Lcom/android/server/power/DisplayPowerController;->mZteAutoBrightnessAdjObserver:Landroid/database/ContentObserver;

    invoke-virtual {v5, v6}, Lcom/android/server/power/ZteBrightnessUtils;->zteAutoControlregisterContentObserver(Landroid/database/ContentObserver;)V
...
.method static synthetic access$000(Lcom/android/server/power/DisplayPowerController;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1400(Lcom/android/server/power/DisplayPowerController;)I
    .locals 1
    .parameter "x0"
...
.method private setScreenOn(Z)V
    ...
    invoke-static {v1, v0}, Landroid/os/nubia/breathlight/BreathinglightManager;->updateBreathLightStatus(II)V
...
.method private updateAmbientLux(J)V
    ...
    const-string v6, "updateAmbientLux: Possibly darkened, waiting for 5000 ms: mDarkeningLuxThreshold="
...
.method private updateAutoBrightness(Z)V
    ...
    .line 1158
    .local v14, value:F
    iget-object v2, p0, Lcom/android/server/power/DisplayPowerController;->mZteBrightnessUtils:Lcom/android/server/power/ZteBrightnessUtils;

    iget v3, p0, Lcom/android/server/power/DisplayPowerController;->mAmbientLuxZteControlMode:F

    invoke-virtual {v2, v3}, Lcom/android/server/power/ZteBrightnessUtils;->getLcdValueInZteControltMode(F)I

    move-result v11

    .line 1161
    .local v11, lcdValueIeZteControltMode:I
    ...
    .line 1192
    .local v9, in:F
    invoke-static {v14, v8}, Landroid/util/FloatMath;->pow(FF)F
    ...
    iget-boolean v2, p0, Lcom/android/server/power/DisplayPowerController;->mAutoBrightnessZteControlMode:Z

    if-eqz v2, :cond_6

    invoke-direct {p0, v11}, Lcom/android/server/power/DisplayPowerController;->clampScreenBrightnessBaidu(I)I
