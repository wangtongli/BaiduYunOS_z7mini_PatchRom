...
.method private enqueueNotification(Landroid/net/NetworkPolicy;IJ)V
    ...
    iget-object v5, v0, Lcom/android/server/net/NetworkPolicyManagerService;->mTime:Landroid/util/TrustedTime;

    move-object/from16 v0, p1

    invoke-static {v1, v0, v3, v5}, Lcom/android/server/net/SwitchSimCautionUtils;->isSwitchSimNeeded(Ljava/util/HashMap;Landroid/net/NetworkPolicy;Landroid/net/INetworkStatsService;Landroid/util/TrustedTime;)Z

    move-result v1

    if-eqz v1, :cond_0

    const v1, #android:string@data_usage_multi_sim_warning_body#t

    invoke-virtual {v15, v1}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v12

    .local v12, multiSimBody:Ljava/lang/CharSequence;
    move-object/from16 v0, p0
    ...
    invoke-static {v1, v10, v3, v12}, Lcom/android/server/net/SwitchSimCautionUtils;->addSwitchIntentToBuilder(Landroid/content/Context;Landroid/app/Notification$Builder;Landroid/net/NetworkTemplate;Ljava/lang/CharSequence;)V

    goto :goto_0

    .line 763
    .end local v12           #multiSimBody:Ljava/lang/CharSequence;
    :cond_0
    move-object/from16 v0, p1
    ...
    invoke-static {v6, v13, v14}, Landroid/text/format/Formatter;->formatFileSize(Landroid/content/Context;J)Ljava/lang/String;

    move-result-object v6

    aput-object v6, v3, v5

    invoke-virtual {v15, v1, v3}, Landroid/content/res/Resources;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method private readPolicyLocked()V
    ...
    .line 1234
    const-string v3, "switchSimCaution"
    ...
    invoke-direct/range {v3 .. v17}, Landroid/net/NetworkPolicy;-><init>(Landroid/net/NetworkTemplate;ILjava/lang/String;JJJJZZZ)V
...
.method private updateNotificationsLocked()V
    ...
    invoke-static {v0}, Lcom/android/server/net/SwitchSimCautionUtils;->notifyUnderWarningLocked(Landroid/net/NetworkTemplate;)V
    ...
    iget-object v14, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mTime:Landroid/util/TrustedTime;

    invoke-static {v0, v10, v1, v14}, Lcom/android/server/net/SwitchSimCautionUtils;->isSwitchSimNeeded(Ljava/util/HashMap;Landroid/net/NetworkPolicy;Landroid/net/INetworkStatsService;Landroid/util/TrustedTime;)Z
    ...
    invoke-static {v0, v1}, Lcom/android/server/net/SwitchSimCautionUtils;->notifyOverWarningLocked(Landroid/net/NetworkTemplate;Landroid/content/Context;)V
...
.method private writePolicyLocked()V
    ...
    .line 1334
    const-string v10, "switchSimCaution"

    iget-boolean v11, v6, Landroid/net/NetworkPolicy;->switchSimCaution:Z
