...
.method private createAllApnList()V
    ...
    invoke-virtual {p0, v8}, Lcom/android/internal/telephony/dataconnection/DcTracker;->getFamilyFromRadioTechnology(I)I
...
.method private isNvSubscription()Z
    ...
    .line 2182
    :cond_1
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/dataconnection/DcTracker;->getFamilyFromRadioTechnology(I)I
...
.method private onRecordsLoaded()V
    ...
    .line 1503
    invoke-virtual {p0}, Lcom/android/internal/telephony/dataconnection/DcTracker;->setCurrentCardSimOperator()V
...
.method protected getFamilyFromRadioTechnology(I)I
    .locals 3
    .parameter "radioTech"
    ...
    .line 2754
    .local v1, networkOperNumeric:Ljava/lang/String;
    invoke-virtual {p0}, Lcom/android/internal/telephony/dataconnection/DcTracker;->isDualModelCard()Z
    ...
    :cond_1
    invoke-static {p1}, Lcom/android/internal/telephony/uicc/UiccController;->getFamilyFromRadioTechnology(I)I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, v4}, Lcom/android/internal/telephony/dataconnection/DcTracker;->tryRestartDataConnections(Ljava/lang/String;)V
    ...
    invoke-virtual {v4}, Lcn/nubia/config/ConfigFactory;->getFeature()Lcn/nubia/config/IFeature;

    move-result-object v4

    invoke-interface {v4}, Lcn/nubia/config/IFeature;->should1xRttDataNet()Z
    ...
    invoke-virtual {p0}, Lcom/android/internal/telephony/dataconnection/DcTracker;->isOtherCardActivated()Z
    ...
    .line 2590
    const-string v4, "dsds not allow 1xRtt Connected to net"

    invoke-virtual {p0, v3, v2, v4}, Lcom/android/internal/telephony/dataconnection/DcTracker;->onCleanUpConnection(ZILjava/lang/String;)V
    ...
    .line 2593
    const-string v3, "onTrySetupData: reason : otherCard is not activated or DataRadioTechnology != 1xRtt"
    ...
    .line 2603
    .end local v1           #hasDisconnected:Z
    :sswitch_a
...
.method protected isDataAllowed(Lcom/android/internal/telephony/dataconnection/ApnContext;)Z
    ...
    invoke-virtual {v1}, Lcn/nubia/config/ConfigFactory;->getFeature()Lcn/nubia/config/IFeature;

    move-result-object v1

    invoke-interface {v1}, Lcn/nubia/config/IFeature;->should1xRttDataNet()Z
...
.method public isDualModelCard()Z
    .locals 6
    ...
    .line 2738
    .local v1, mUiccController:Lcom/android/internal/telephony/uicc/UiccController;
    ...
    invoke-virtual {v1, v4}, Lcom/android/internal/telephony/uicc/UiccController;->getIccRecords(I)Lcom/android/internal/telephony/uicc/IccRecords;
...
.method protected isOtherCardActivated()Z
    .locals 1
...
.method protected onUpdateIcc()Z
    ...
    .line 2661
    const-string v7, "onUpdateIcc: mUiccController is null. Error!"
    ...
    .line 2666
    .local v2, dataRat:I
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/dataconnection/DcTracker;->getFamilyFromRadioTechnology(I)I
    ...
    const-string v10, "onUpdateIcc: newIccRecords "
    ...
    .line 2681
    .local v1, appFamilyShould:I
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/dataconnection/DcTracker;->getUiccRecords(I)Lcom/android/internal/telephony/uicc/IccRecords;

    move-result-object v4

    .line 2682
    .local v4, newIccRecordsShould:Lcom/android/internal/telephony/uicc/IccRecords;
    if-eq v5, v4, :cond_3
    ...
    invoke-virtual {v3, p0, v7, v8}, Lcom/android/internal/telephony/uicc/IccRecords;->registerForRecordsLoaded(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public setCurrentCardSimOperator()V
    .locals 2
