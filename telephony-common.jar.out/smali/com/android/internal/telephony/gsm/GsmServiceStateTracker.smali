...
.method private pollStateDone()V
    ...
    .line 972
    .local v33, preVoiceServiceState:I
    move-object/from16 v0, p0
    ...
    .line 973
    .local v32, preDataServiceState:I
    move-object/from16 v0, p0
    ...
    .line 974
    .local v12, curVoiceServiceState:I
    move-object/from16 v0, p0
    ...
    .line 975
    .local v11, curDataServiceState:I
    move-object/from16 v0, p0
    ...
    const-string v44, "preVoiceServiceState: "
    ...
    const-string v44, ", preDataServiceState: "
    ...
    const-string v44, ", curVoiceServiceState: "
    ...
    const-string v44, ", curDataServiceState: "
    ...
    invoke-virtual/range {v43 .. v43}, Landroid/telephony/MSimTelephonyManager;->isMultiSimEnabled()Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isSubActive(I)Z

    move-result v26

    .line 1150
    .local v26, isCardOneActive:Z
    const/16 v43, 0x1
    ...
    .line 1152
    .local v27, isCardTwoActive:Z
    new-instance v43, Ljava/lang/StringBuilder;

    invoke-direct/range {v43 .. v43}, Ljava/lang/StringBuilder;-><init>()V

    const-string v44, "isCardOneActive: "
    ...
    const-string v44, ", isCardTwoActive: "
    ...
    iput-object v0, v1, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mTimer:Ljava/util/Timer;
    ...
    new-instance v44, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$4;

    move-object/from16 v0, v44

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$4;-><init>(Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;)V

    const-wide/16 v45, 0x3a98

    invoke-virtual/range {v43 .. v46}, Ljava/util/Timer;->schedule(Ljava/util/TimerTask;J)V

    .line 1200
    .end local v26           #isCardOneActive:Z
    .end local v27           #isCardTwoActive:Z
    ...
    invoke-virtual/range {v43 .. v44}, Lcom/android/internal/telephony/PhoneBase;->notifyDataConnection(Ljava/lang/String;)V
    ...
    invoke-virtual/range {v43 .. v43}, Lcom/android/internal/telephony/PhoneBase;->getContext()Landroid/content/Context;
    ...
    .line 904
    .end local v11           #curDataServiceState:I
    .end local v12           #curVoiceServiceState:I
    ...
    .end local v32           #preDataServiceState:I
    .end local v33           #preVoiceServiceState:I
    ...
    .line 1034
    .restart local v11       #curDataServiceState:I
    .restart local v12       #curVoiceServiceState:I
    .restart local v19       #hasLocationChanged:Z
    .restart local v31       #operatorNumeric:Ljava/lang/String;
    .restart local v32       #preDataServiceState:I
    .restart local v33       #preVoiceServiceState:I
    ...
    .line 1174
    .restart local v26       #isCardOneActive:Z
    .restart local v27       #isCardTwoActive:Z
    :cond_2b
    const-string v43, "notifyServiceStateChanged"
...
.method public notifyServiceStateChange()V
    .locals 2

    .prologue
    .line 2026
    const-string v0, "EVENT_SUBSCRIPTION_DEACTIVATED notifyServiceStateChange"
    ...
    .line 2028
    iget-object v0, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mTimer:Ljava/util/Timer;
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mTimer:Ljava/util/Timer;
