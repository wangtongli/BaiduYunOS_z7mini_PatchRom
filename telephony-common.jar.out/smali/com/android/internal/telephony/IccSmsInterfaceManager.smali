...
.method private isContactsUid(I)Z
    .locals 5
    .parameter "uid"
    ...
    .line 939
    .local v0, CONTACTS_PKG:Ljava/lang/String;
    const/4 v1, -0x1

    .line 941
    .local v1, contactsUid:I
    :try_start_0
...
.method public getAllMessagesFromIccEf(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-direct {p0, v5}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->isContactsUid(I)Z

    move-result v2

    .line 299
    .local v2, isContactUid:Z
    invoke-static {}, Landroid/os/Binder;->getCallingUid()I

    move-result v5

    invoke-direct {p0, v5}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->isMmsUid(I)Z
    ...
    invoke-virtual {v1, v5, v4}, Lcom/android/internal/telephony/uicc/IccFileHandler;->loadEFLinearFixedAll(ILandroid/os/Message;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public getSmscAddress()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/PhoneBase;->getSmscAddress()Ljava/lang/String;
...
.method public readSmscAddress()V
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/PhoneBase;->readSmscAddress()V
...
.method public setSmscAddress(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/telephony/PhoneBase;->setSmscAddress(Ljava/lang/String;)V
...
.method public updateMessageOnIccEf(Ljava/lang/String;II[B)Z
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->isContactsUid(I)Z

    move-result v7

    .line 202
    .local v7, isContactUid:Z
    invoke-static {}, Landroid/os/Binder;->getCallingUid()I
    ...
    invoke-virtual {v2, v4, v9, p1}, Landroid/app/AppOpsManager;->noteOp(IILjava/lang/String;)I
