...
.method private static createMessageListFromRawRecords(ILjava/util/List;)Ljava/util/ArrayList;
    .locals 7
    ...
    invoke-static {p0, v5, v6}, Landroid/telephony/SmsMessage;->createFromEfRecord(II[B)Landroid/telephony/SmsMessage;
...
.method public getAllMessagesFromIcc(I)Ljava/util/ArrayList;
    ...
    :cond_0
    :goto_0
    invoke-static {p1, v1}, Landroid/telephony/MSimSmsManager;->createMessageListFromRawRecords(ILjava/util/List;)Ljava/util/ArrayList;
...
.method public getSmscAddress(I)Ljava/lang/String;
    ...
    .line 782
    invoke-interface {v1, p1}, Lcom/android/internal/telephony/msim/ISmsMSim;->getSmscAddress(I)Ljava/lang/String;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public readSmscAddress(I)V
    ...
    .line 767
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/msim/ISmsMSim;->readSmscAddress(I)V
    :try_end_0
...
.method public setSmscAddress(Ljava/lang/String;I)V
    ...
    .line 799
    invoke-interface {v0, p1, p2}, Lcom/android/internal/telephony/msim/ISmsMSim;->setSmscAddress(Ljava/lang/String;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
